...
class TestInfo(unittest.TestCase):
    def setUp(self):
        self.new_info =Info("charles.opuba","opuba.charles")
    def test_init(self):
        self.assertEqual(self.new_info.face_bookp,"charles.opuba")
        self.assertEqual(self.new_info.email_p,"opuba.charles")
